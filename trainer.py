...
from optimizer.optimizer import get_scheduler_and_optimizer
...
def train(train_dataset, eval_dataset, model, tokenizer):
    ...
    args.logging_steps = args.logging_steps
    ...
    optimizer, scheduler = get_scheduler_and_optimizer(args, model, t_total)
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if (args.local_rank == -1 and args.evaluate_during_training):
                        eval_loss, metrics = evaluate(eval_dataloader, model, prefix=global_step)

                        tb_writer.add_scalar("loss/eval_loss", loss.item(), global_step)
                    ...
                    tb_writer.add_scalar("loss/train_loss", loss.item(), global_step)
